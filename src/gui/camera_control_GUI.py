...
class CamGUI(object):
    ...
    def createGUI(self):
        ...
        Button(self.window, text="SYNC_WITH_SYNAPSE", command=self.sync_setup).grid(sticky="nsew", row=cur_row, column=2, columnspan=2)
        cur_row += 1
        #cur_row += 1
        ...
        self.received_pulse_label.grid(row=cur_row, column=2, sticky="w")
        cur_row += 1
        ...
        # trigger
        #Label(self.window, text="Trigger: ").grid(sticky="w",row=cur_row, column=0)
        #self.trigger_on = IntVar(value=0)
        #self.trigger_button_on = Radiobutton(self.window, text="On", selectcolor='green', indicatoron=0, variable=self.trigger_on, value=1).grid(sticky="nsew", row=cur_row, column=2)
        #self.trigger_button_off = Radiobutton(self.window, text="Off", selectcolor='red', indicatoron=0, variable=self.trigger_on, value=0).grid(sticky="nsew", row=cur_row, column=1)
        #cur_row +=1
